...
order: 130
icon: list-check
summary: A computed condition nobody has looked at has had no consequence. Four mechanisms close that — a summary of the estate as it is, a worklist derived rather than assigned, twelve idempotent jobs that record what has become true, and a digest that reaches out — plus the compliance debt an imported estate carries honestly.
