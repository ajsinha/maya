...
| Database | SQLite by default, PostgreSQL by URL alone. Two hand-written schemas, **50 tables**, no migrations |
...
│   └── schema/                      two hand-written schemas, 50 tables, no migrations
