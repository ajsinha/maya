...
| Database | SQLite by default, PostgreSQL by URL alone. One typed schema, **88 tables**, DDL generated per dialect, no migrations — and that is a position, not a gap: [19 §4](docs/19-deploying-maya.md) says what a deployer does instead |
