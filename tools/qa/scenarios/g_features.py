...
from tools.qa.scenarios.common import (FAIL, PASS, Ctx, Result, case, code_of,
                                       valid_body)
...
@case("QA-FX-410", "A well-formed feature is accepted")
...
@case("QA-FX-411", "The same feature name twice")
...
@case("QA-FX-412", "A feature declared as personal data")
...
@case("QA-FX-413", "A feature naming a protected basis")
...
@case("QA-FX-414", "A featureset over a feature that does not exist")
...
@case("QA-FX-416", "Retire a feature that does not exist")
...
@case("QA-FX-418", "A feature expression that references itself")
