...
data = [["Concern", "Today", "Why, or why not yet"],
        ...
        ["CSRF", "A token on any state-changing method whose authority came from the cookie, enforced in middleware", "225 mutating endpoints is 126 chances to forget one"],
