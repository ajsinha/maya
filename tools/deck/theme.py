...
CRIMSON_D = RGBColor(0x76, 0x14, 0x22)   # deep crimson
CRIMSON_L = RGBColor(0xC8, 0x5A, 0x6A)   # light crimson
INK       = RGBColor(0x1C, 0x1C, 0x1E)
SLATE     = RGBColor(0x4A, 0x4F, 0x57)
MUTED     = RGBColor(0x7A, 0x7F, 0x87)
RULE      = RGBColor(0xD8, 0xD4, 0xCF)
PARCH     = RGBColor(0xF6, 0xF3, 0xEF)   # parchment
PARCH_D   = RGBColor(0xEA, 0xE4, 0xDC)
WHITE     = RGBColor(0xFF, 0xFF, 0xFF)
NAVY      = RGBColor(0x2E, 0x40, 0x57)   # secondary data colour
