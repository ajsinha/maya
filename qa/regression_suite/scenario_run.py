...
Runs the hand-written cases, one at a time, against a live instance.
    ...
    python -m qa.regression_suite.scenario_run                 # everything registered
    python -m qa.regression_suite.scenario_run --only QA-DEL   # one prefix
...
def _isolated(case_id: str, fn):
    ...
    did not do.
    """
    from qa.regression_suite.harness import PEOPLE, UNPRIVILEGED, live_client
