...
| ADR | Title | Status |
|---|---|---|
| [001](ADR-001-modular-monolith.md) | Modular monolith with one extracted hook service | accepted |
...
| [007](ADR-007-hook-protocol.md) | Signed, TTL'd, alias-aware hook descriptors | accepted |
