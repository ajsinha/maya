...
the 204 modules that pass and carries 61 in a backlog file, because `mypy || true` is a step that
always passes — the defect this codebase is named for — and `--strict` across 265 modules in one
