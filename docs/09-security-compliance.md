...
|---|---|---|
| Enforcement point | One middleware in `run_maya_web.py`, not a check in each route. There are **124 mutating endpoints**, and a control 107 places have to remember will be missing from the 108th | Code (`core/authz/csrf.py`) |
