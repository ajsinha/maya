...
|---|---|---|
| Enforcement point | One middleware in `run_maya_web.py`, not a check in each route. There are **104 mutating endpoints**, and a control 104 places have to remember will be missing from the 105th | Code (`core/authz/csrf.py`) |
