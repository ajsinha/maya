...
|---|---|---|
| Enforcement point | One middleware in `run_maya_web.py`, not a check in each route. There are **194 mutating endpoints**, and a control 125 places have to remember will be missing from the 126th | Code (`core/authz/csrf.py`) |
