...
\subsection{One case study that was not designed to fit}

The objection above applies to the worked examples as much as to the modules: fourteen demonstrations
written by the author of the platform establish that the thing is self-consistent and very little else. A
fifteenth built the same way would not help.

So the fourteenth is taken from the public record. It reconstructs the model governance failure at the
...
second audience: nineteen help pages and eight walkthroughs that state each derivation in operational terms
