...
governance register of some 316 modules and 5{,}279 tests --- \url{https://github.com/ajsinha/maya} ---
...
is the account of what building it required. At the revision this text describes it is 316 Python modules
that type-check cleanly, 82 tables in one typed schema from which both dialects' DDL is generated, 487
locked HTTP paths, and 5{,}279 tests that run on every push.
...
\Cref{sec:automation} written as thirteen refusals and what each protects. A reader who wants the argument and
