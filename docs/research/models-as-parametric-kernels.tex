...
governance register of some 307 modules and 5{,}174 tests --- \url{https://github.com/ajsinha/maya} ---
...
is the account of what building it required. At the revision this text describes it is 307 Python modules
that type-check cleanly, 80 tables in one typed schema from which both dialects' DDL is generated, 466
locked HTTP paths, and 5{,}174 tests that run on every push.
...
\Cref{sec:automation} written as nine refusals and what each protects. A reader who wants the argument and
