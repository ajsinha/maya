...
governance register of some 317 modules and 5{,}340 tests --- \url{https://github.com/ajsinha/maya} ---
...
is the account of what building it required. At the revision this text describes it is 317 Python modules
that type-check cleanly, 82 tables in one typed schema from which both dialects' DDL is generated, 491
locked HTTP paths, and 5{,}340 tests that run on every push.
