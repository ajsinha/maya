...
Each claim is marked with where it is enforced. Fifteen of the twenty-one stated laws execute against
...
\item \Cref{sec:laws} states the discipline that keeps the rest from becoming ornament, gives the
      register of twenty-one laws with the six that do not execute named, and records three defects that
