...
CREATE TABLE IF NOT EXISTS approval_condition (
    ...
    imposed_at DOUBLE NOT NULL,
    expires_at DOUBLE NOT NULL,
    confirmed_by TEXT,
    confirmed_at DOUBLE,
    confirm_every_days DOUBLE DEFAULT (30.0) NOT NULL,
    state TEXT DEFAULT 'active' NOT NULL,
    discharged_at DOUBLE,
    discharged_by TEXT,
...
CREATE TABLE IF NOT EXISTS authority_band (
    ...
    name TEXT NOT NULL,
    tier INTEGER,
    at_or_above DOUBLE DEFAULT 0 NOT NULL,
    legal_entity TEXT,
    stages TEXT DEFAULT '[]' NOT NULL,
    note TEXT DEFAULT '' NOT NULL,
    published_by TEXT NOT NULL,
    published_at DOUBLE NOT NULL,
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS break_glass (
    ...
    reason TEXT NOT NULL,
    authorised_by TEXT,
    unilateral BOOLEAN DEFAULT 0 NOT NULL,
    opened_at DOUBLE,
    expires_at DOUBLE,
    closed_at DOUBLE,
    closed_by TEXT,
...
CREATE TABLE IF NOT EXISTS elicitation_response (
    ...
    independent BOOLEAN DEFAULT 1 NOT NULL,
    dissented BOOLEAN DEFAULT 0 NOT NULL,
    recorded_at DOUBLE NOT NULL,
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS model_decommission (
    ...
    consumers_known BOOLEAN DEFAULT 0 NOT NULL,
    decommissioned_by TEXT NOT NULL,
    decommissioned_at DOUBLE NOT NULL,
    PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS parallel_run (
    ...
    purpose TEXT NOT NULL,
    tolerance DOUBLE DEFAULT (1e-9) NOT NULL,
...
CREATE TABLE IF NOT EXISTS validator_capacity (
    ...
    episodes_per_quarter DOUBLE NOT NULL,
    note TEXT DEFAULT '' NOT NULL,
    declared_by TEXT NOT NULL,
    declared_at DOUBLE NOT NULL,
    PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS warrant (
    ...
    quota INTEGER,
    quota_window_hours DOUBLE DEFAULT (24.0) NOT NULL,
    cost_budget DOUBLE,
